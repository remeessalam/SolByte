    ...
    >
      ...
      <div data-aos="fade-up" className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="py-[3rem] px-5 bg-white/80 rounded-xl backdrop-blur-sm text-primary_text relative z-10">
            <h1
              data-aos="fade-up"
            ...
            <h2 className="sub-heading text-center max-w-[60rem] mt-3 mx-auto">
              At SolByte Tech, we believe in the power of:
            </h2>
            <div
              data-aos="fade-up"
            ...
            >
              {content.map((item, index) => (
                <div
                  key={index}
                  className="flex shadow-inner shadow-primary/40 flex-col group items-center gap-1 bg-white/50 rounded-xl p-5 transition-all duration-200"
                >
                  <div className="flex justify-between items-center w-full">
                    ...
                    <div className="w-[3.5rem] h-[3.5rem] flex justify-center items-center rounded-full bg-primary">
